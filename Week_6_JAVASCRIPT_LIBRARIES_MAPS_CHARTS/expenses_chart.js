//  adding an input field for the expenses name,amount
...
addExpenseButton.addEventListener('click', function() {
    ...
    let errors = []
    //  adding new expenses to chart data
