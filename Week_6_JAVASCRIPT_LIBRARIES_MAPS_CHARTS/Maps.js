...
//     .bindPopup('Minneapolis College<br><a href="https://minneapolis.edu">Websites</a>')
//     .addTo(map)
//
//
//
//
// let stPaulCoordinate = [44.9483, -93.1099]
// let stpMarker = L.marker(stPaulCoordinate)
//     .bindPopup('Saint Colllege<br><a href="https://saintpaul.edu">Websites</a>"')
//     .addTo(map)
//
//
// let normandaleCoordinates = [44.8297, -93.3312]
// let normandaleMarker = L.marker(normandaleCoordinates)
//     .bindPopup('Normandale College<br><a href="https://normandale.edu">Websites</a>"')
//     .addTo(map)
//
//
//
